...
public class Preference {
	...
	public void populateLists() {
		...
		Foods.add(new Food("Norms Porterhouse Steak", 1, 300, "Steak", "American"));
	...
	// Tag options for drop down menu
	...
	// each of the following cheat pickers take a string value that is predetermined
	// by the corresponding drop-down menu
